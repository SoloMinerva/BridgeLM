"""Benchmark KV Cache vs no-cache generation for bridgelm.
...
from bridgelm.model.transformer import KVCache
from bridgelm.tokenizer import BPETokenizer


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Benchmark KV Cache for bridgelm")
