"""bridgelm interactive multi-turn chat REPL.
...
from bridgelm.model import TransformerLM, apply_lora_to_model, load_lora_state_dict, merge_lora
from bridgelm.tokenizer import BPETokenizer
from bridgelm.training.sft import ROLE_MARKERS
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="bridgelm interactive multi-turn chat.",
...
def repl(session: ChatSession) -> None:
    ...
    print("=" * 60)
    print("  bridgelm Chat  (type /help for commands, /quit to exit)")
    print("=" * 60)
